...
@section('content')
    <div
        class="max-w mx-auto shadow-md overflow-hidden mt-6 p-10"style="
                background: url('{{ asset('img/hero-three-bg.jpg') }}') no-repeat
                  center center/cover;
              ">
        <div class="md:flex">
            <div class="md:shrink-0 text-white">
                <h1 class="text-5xl leading-snug xl:text-[66px] mb-8 xl:leading-normal font-bold text-white">
                    ...
                    <span class="inline-block"
                        style="
                    background: url('{{ asset('img/wide-line.svg') }}')
                      no-repeat bottom;
                  ">
                        Web Developer</span>
                </h1>
                ...
                <div class="flex items-center gap-8 mt-10">
                    <a href="#"
                        class="bg-lime-500 text-interface-100 px-6 py-4 rounded-lg inline-flex justify-center items-center hover:bg-lime-600 font-medium transition-all">
                        <span>Hire Me</span>
                ...
                <div class="pt-14">
                    <p class="text-base text-interface-200">
                        Over
                        <span class="text-lime-300 font-semibold text-xl">50,000+ client</span>
                        all over the world.
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-7">
                <div class="group">
                    <a href="https://stackoverflow.com/users/9432459/sayed-bilal-hussain"
                        ...
                        <svg class="group-hover:fill-interface-100 fill-white" width="40" height="40"
                            ...
                            <g clip-path="url(#clip0_537_18847)">
                                ...
                                <path d="M10.3584 29.2852H27.9684V32.8302H10.3584V29.2852Z"></path>
                                <path d="M13 16.385L28.9533 23.9283L30.4317 20.6883L14.47 13.125L13 16.385Z"></path>
                                <path d="M28.955 23.9294L28.9533 23.9277L28.9517 23.9294H28.955Z" fill="white"></path>
                                ...
                                <path d="M36.6669 14.3117L26.1635 0L23.3452 2.14333L33.8485 16.455L36.6669 14.3117Z"></path>
                            </g>
                            <defs>
                ...
                <div class="group">
                    <a href="https://github.com/ShamsaFarooq74"
                        class="group-hover:bg-lime-500 group-hover:border-transparent transition-all flex space-x-3 p-8 rounded-xl border border-dashed bg-[#0A1429] border-[#3A3E4E] items-center justify-center">
                        <svg class="fill-white group-hover:fill-interface-500" width="40" height="40"
                            viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="group">
                    <a href="#"
                        class="group-hover:bg-lime-500 group-hover:border-transparent transition-all flex space-x-3 p-8 rounded-xl border border-dashed bg-[#0A1429] border-[#3A3E4E] items-center justify-center">
                        <svg class="fill-white group-hover:fill-interface-100" width="40" height="40"
                            viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <span
                            class="text-white transition-all group-hover:text-interface-100 text-2xl font-semibold">Medium</span>
                    </a>
                </div>
                <div class="group">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 gap-5 xl:gap-10 lg:gap-16 place-items-center mb-14">
                <div class="xl:col-span-2">
                    <h2 class="text-white font-bold lg:text-5xl text-4xl capitalize leading-snug">
                        ...
                        <span class="relative">
                            ...
                            <svg class="absolute  -left-1 z-0 -top-2 hidden md:block" width="206" height="75"
                                viewBox="0 0 206 75" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <div class="xl:col-span-3">
                    <p class="text-white text-xl">
                        E-commerce Website,Custom Web Application,Content Management System (CMS),API Integration,Booking and Reservation System,
                        Social Media Application,API Development,
                    </p>
                </div>
            </div>
            <div class="shadow-md overflow-hidden md:max-w-7xl">
                <div class="md:flex">
                    @foreach ($services as $key => $service)
                        <div class="md:shrink-0">
                            <article class="swiper-slide swiper-slide-prev" role="group" aria-label="1 / 4"
                                data-swiper-slide-index="0" style="width: 385.333px; margin-right: 30px;">
                                <div
                                    class="relative transition duration-200 cursor-pointer border border-transparent hover:border-lime-500 bg-interface-600 px-7 py-8 group shadow-customThree rounded-custom">
                                    <div
                                        class="w-[70px] h-[70px] rounded-full group-hover:bg-opacity-10 bg-opacity-10 pl-5 pt-3 mb-6" style="
                                        background: url('{{ asset('assets/uploads/thumbnails/' . $service->thumbnail) }}') no-repeat center
                                          center/cover;
                                      ">
                                    </div>
                                    ...
                                    <a href="{{ url('service-detail/' . $service->id) }}"
                                        class="underline flex relative group-hover:text-lime-500 z-10 items-center text-white">
                                        <span>Learn more</span>
                                        <svg class="stroke-white group-hover:stroke-lime-500" width="25"
                                            height="26" viewBox="0 0 25 26" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M7.10156 18.0748L17.2491 7.92383" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M7.10156 7.92383H17.2491V18.0748" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                    </a>
                                </div>
                    ...
                    @endforeach
                    {{-- <div class="p-1">
                        <article class="swiper-slide swiper-slide-next" role="group" aria-label="3 / 4"
                            data-swiper-slide-index="2" style="width: 385.333px; margin-right: 30px;">
                            <div
                                class="relative transition duration-200 cursor-pointer border border-transparent hover:border-lime-500 bg-interface-600 px-7 py-8 group shadow-customThree rounded-custom">
                                <div
                                    class="w-[70px] h-[70px] rounded-full bg-lime-500 group-hover:bg-opacity-10 bg-opacity-10 pl-5 pt-3 mb-6">
                                    <svg class="fill-lime-500" width="58" height="58" viewBox="0 0 58 58"
                                ...
                                <a href="service-pd.html"
                                    class="underline flex relative group-hover:text-lime-500 z-10 items-center text-white">
                                    <span>Learn more</span>
                                    <svg class="stroke-white group-hover:stroke-lime-500" width="25" height="26"
                    ...
                    <div>
                        <article class="swiper-slide" role="group" aria-label="4 / 4" data-swiper-slide-index="3"
                            style="width: 385.333px; margin-right: 30px;">
                            <div
                                class="relative transition duration-200 cursor-pointer border border-transparent hover:border-lime-500 bg-interface-600 px-7 py-8 group shadow-customThree rounded-custom">
                                <div
                                    class="w-[70px] h-[70px] rounded-full bg-lime-500 group-hover:bg-opacity-10 bg-opacity-10 pl-5 pt-3 mb-6">
                                    <svg class="stroke-lime-500" width="58" height="58" viewBox="0 0 58 58"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="grid lg:grid-cols-3 gap-5 xl:gap-10 items-center py-12 md:py-20">
                    <div class="pb-4">
                        ...
                        <p class="text-white text-lg mt-5 leading-normal">
                            Hi there! My name is Shamsa Farooq, and I'm a web developer
                            based in Lahore, Pakistan. I have a passion .
                        </p>
                        ...
                        <ul class="divide-y divide-[#494C5F]">
                            <li class="flex justify-between items-center pl-4 py-5">
                                <div>
                                    ...
                                    <svg width="84" height="19" viewBox="0 0 84 19" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_537_18642)">
                                            <path
                                                ...
                                                fill="#F4F8F7"></path>
                                            <path d="M8.49911 8.71591H0V0.216797H8.49911V8.71591Z" fill="#F1511B"></path>
                                            <path d="M17.8829 8.71591H9.38379V0.216797H17.8829V8.71591Z" fill="#80CC28">
                                            </path>
                                            <path d="M8.49895 18.1026H0V9.60352H8.49895V18.1026Z" fill="#00ADEF"></path>
                                            <path d="M17.8829 18.1026H9.38379V9.60352H17.8829V18.1026Z" fill="#FBBC09">
                                            </path>
                                        </g>
                                        <defs>
                                            <clipPath id="clip0_537_18642">
                                                <rect width="83.7818" height="18" fill="white"
                                                    transform="translate(0 0.216797)"></rect>
                                            </clipPath>
                                        </defs>
                                    </svg>
                                </div>
                                <div>
                                    <span class="bg-lime-500 px-3 py-2 rounded-md">
                                        Current</span>
                                </div>
                            </li>
                            <li class="flex justify-between items-center pl-4 py-5">
                                <div>
                                    ...
                                    <svg width="41" height="19" viewBox="0 0 41 19" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <clipPath id="clip0_537_18632">
                                                <rect width="40.5" height="18" fill="white"
                                                    transform="translate(0 0.216797)"></rect>
                                            </clipPath>
                                        </defs>
                                    </svg>
                                ...
                                <div class="shrink-0">
                                    <span class="border border-lime-500 text-lime-500 px-3 py-2 rounded-md">
                                        2018-2020</span>
                                </div>
                            </li>
                            <li class="flex justify-between items-center pl-4 py-5">
                ...
                <div class="grid lg:grid-cols-2 gap-x-20 gap-y-10">
                    ...
                    <div>
                        ...
                        <ul class="mt-7 flex flex-wrap gap-3">
                            <li>
                                <a href="#"
                                    class="bg-[#16213B] block px-4 py-3 hover:bg-lime-500 hover:text-interface-100 transition rounded-md text-white text-xl">Html</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="bg-[#16213B] block px-4 py-3 hover:bg-lime-500 hover:text-interface-100 transition rounded-md text-white text-xl">CSS</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="bg-[#16213B] block px-4 py-3 hover:bg-lime-500 hover:text-interface-100 transition rounded-md text-white text-xl">Front-end</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="bg-[#16213B] block px-4 py-3 hover:bg-lime-500 hover:text-interface-100 transition rounded-md text-white text-xl">PHP</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="bg-[#16213B] block px-4 py-3 hover:bg-lime-500 hover:text-interface-100 transition rounded-md text-white text-xl">Back-end</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="bg-[#16213B] block px-4 py-3 hover:bg-lime-500 hover:text-interface-100 transition rounded-md text-white text-xl">Java
                                    Script</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="bg-[#16213B] block px-4 py-3 hover:bg-lime-500 hover:text-interface-100 transition rounded-md text-white text-xl">Laravel</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="bg-[#16213B] block px-4 py-3 hover:bg-lime-500 hover:text-interface-100 transition rounded-md text-white text-xl">C++</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="bg-[#16213B] block px-4 py-3 hover:bg-lime-500 hover:text-interface-100 transition rounded-md text-white text-xl">Vue.js</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="mt-7 flex flex-wrap gap-x-12 gap-y-7">
                            <li>
                                <svg class="fill-[#1D2A47] hover:fill-lime-500 transition" width="52" height="53"
                                    ...
                                    <defs>
                                        <clipPath id="clip0_537_18541">
                                            <rect width="52" height="52" transform="translate(0 0.288086)"></rect>
                                        </clipPath>
                                    </defs>
                                </svg>
                            </li>
                            <li>
                                <svg class="fill-[#1D2A47] hover:fill-lime-500 transition" width="53" height="53"
                            ...
                            <li>
                                <svg class="fill-[#1D2A47] hover:fill-lime-500 transition" width="54" height="53"
                                    viewBox="0 0 54 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs>
                                        <clipPath id="clip0_537_18555">
                                            <rect width="52.6265" height="52"
                                                transform="translate(0.722656 0.288086)"></rect>
                                        </clipPath>
                                    </defs>
                                </svg>
                            </li>
                                    ...
                                    <defs>
                                        <clipPath id="clip0_537_18581">
                                            <rect width="52" height="52" fill="white"
                                                transform="translate(0.90918 0.288086)"></rect>
                                        </clipPath>
                                    </defs>
                                </svg>
                            </li>
    ...
    <section class="pb-120">
        <div class="mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div class="max-w-xl mx-auto mb-10 text-center">
                <h2 class="text-4xl leading-normal xl:text-5xl xl:leading-snug font-bold text-white mb-4">
                    ...
                    <span class="relative z-30"><span class="relative z-10"> Projects</span>
                        <svg class="absolute right-0 bottom-1" width="200" height="10" viewBox="0 0 243 10"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3 7C45.1729 3.98151 151.615 -0.244386 240 7" stroke="#FFD233" stroke-width="6"
            ...
            {{-- <div class="relative group min-h-[370px] rounded-lg cursor-pointer overflow-hidden lg:col-span-2"
                style="
                background: url('{{ asset('img/ms-2.jpg') }}') no-repeat
                  center center/cover;
              ">
                <div
                    class="bg-interface-100 bg-opacity-0 transition-opacity duration-500 ease-in-out absolute w-full h-full group-hover:bg-opacity-80 rounded-lg flex flex-col items-center justify-center">
                    <div
                        ...
                        <a href="portfolio-details.html"
                            class="grid place-content-center mt-6 px-3 py-2 border border-lime-500 text-lime-500 text-sm rounded">View
                            Project
                        </a>
                    </div>
                </div>
            ...
            <div class="relative group min-h-[370px] rounded-lg cursor-pointer overflow-hidden"
                style="
                background: url('{{ asset('img/ms-3.jpg') }}') no-repeat
                  center center/cover;
              ">
                <div
                    class="bg-interface-100 bg-opacity-0 transition-opacity duration-500 ease-in-out absolute w-full h-full group-hover:bg-opacity-80 rounded-lg flex flex-col items-center justify-center">
            ...
            <div class="relative group min-h-[370px] rounded-lg cursor-pointer overflow-hidden"
                style="
                background: url('{{ asset('img/ms-4.jpg') }}') no-repeat
                  center center/cover;
              ">
                <div
                    class="bg-interface-100 bg-opacity-0 transition-opacity duration-500 ease-in-out absolute w-full h-full group-hover:bg-opacity-80 rounded-lg flex flex-col items-center justify-center">
            ...
            <div class="relative group min-h-[370px] rounded-lg cursor-pointer overflow-hidden"
                style="
                background: url('{{ asset('img/ms-5.jpg') }}') no-repeat
                  center center/cover;
              ">
                <div
                    class="bg-interface-100 bg-opacity-0 transition-opacity duration-500 ease-in-out absolute w-full h-full group-hover:bg-opacity-80 rounded-lg flex flex-col items-center justify-center">
        ...
        <div class="flex justify-center mt-14">
            <a href=""
                class="text-white text-lg font-medium rounded-lg border border-white py-3 px-8 text-center">See
                More</a>
        </div>
        </div>
    </section>
    <section class="mt-10">
        <div class="max-w-md mx-auto rounded-xl shadow-md overflow-hidden md:max-w-7xl py-120"
            style="
      background: url('{{ asset('img/testimonial-bg.jpg') }}') no-repeat
            center center/cover;
        ">
            ...
            <div class="md:flex">
                <div class="shadow-custom rounded-lg bg-[#16213C] p-7 relative">
                    ...
                    <q class="pb-8 block text-xl text-gray-200 italic">
                        Excellent, working with web developer express was great. Thanks to their knowledge and determination
                ...
                <div class="shadow-custom rounded-lg bg-[#16213C] p-7 relative">
                    ...
                    <q class="pb-8 block text-xl text-gray-200 italic">
                        My experience with Web Developer has been fantastic. I have worked with many web design companies
    ...
    <section class="py-20"
        style="
          background: url(' {{ asset('img/dev-cta.jpg') }}') no-repeat center
            center/cover;
        ">
        <div class="mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div class="flex flex-col gap-5 xl:gap-10 lg:flex-row justify-between">
                ...
                <div class="xl:w-5/12">
                    <div class="max-w-lg">
                        ...
                        <a href="{{url('/contact') }}"
                            class="bg-lime-500 group inline-flex py-4 space-x-2 px-7 rounded-xl text-interface-500 text-lg">
